        ...
        <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
            ...
            <x-field>
                <div class="mt-2">
                    ...
                    <x-input type="text" name="title" id="title" value="{{ $post->title }}" required/>
            ...
            <x-field>
                <div class="mt-2">
                    ...
                    <textarea id="text" name="text" rows="8"
                              class="pl-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $post->text }}</textarea>
